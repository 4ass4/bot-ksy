...
export class Keyboards {
    ...
    static mailingsToDelete(mailings) {
    ...
    static mainUser(activeCount, participationCount) {
        const keyboard = new InlineKeyboard();
    ...
    static rafflesToPublish(raffleIndexes) {
        const keyboard = new InlineKeyboard();
    ...
    static channelsToDelete(channels) {
        const keyboard = new InlineKeyboard();
    ...
    static rafflesToDelete(raffles) {
        const keyboard = new InlineKeyboard();
    ...
    static raffleCreatedActions(raffleId) {
        return new InlineKeyboard()
    ...
    static editRaffleFields(hasParticipants) {
        const keyboard = new InlineKeyboard()
    ...
    static referralMainWithContext(raffleId) {
        return new InlineKeyboard()
    ...
    static socialAccountsList(accounts) {
        const keyboard = new InlineKeyboard();
    ...
    static socialAccountActions(accountId) {
        return new InlineKeyboard()
